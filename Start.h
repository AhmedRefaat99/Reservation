...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Headline One", 35, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(169, 60);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(579, 55);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Welcome to our program";
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(497, 274);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(247, 274);
			...
			this->label1->Location = System::Drawing::Point(362, 440);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(161, 13);
			this->label1->TabIndex = 8;
			this->label1->Text = L"Hall Reservation System © 2018";
			// 
			// Start
			// 
...
#pragma endregion
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
				 this->Hide();
				 Login^f2 = gcnew Login(this);
				 f2->Show();
			 }
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				this->Hide();
				SignUp^f1 = gcnew SignUp(this);
				f1->Show();
			 }
